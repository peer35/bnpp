...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_search_field('personen_sm', label: 'Personen') do |field|
      field.solr_parameters = { :'spellcheck.dictionary' => 'personen' }
      field.solr_local_parameters = {
        qf: '$personen_qf',
        pf: '$personen_pf'
      }
		...
		config.add_search_field('titel_s', label: 'Titel') do |field|
			field.solr_parameters = { :'spellcheck.dictionary' => 'titel' }
			field.solr_local_parameters = {
					qf: '$titel_qf',
					pf: '$titel_pf'
			}
		...
		config.add_search_field('eigenaar_s', label: 'Eigenaar') do |field|
			field.solr_parameters = { :'spellcheck.dictionary' => 'eigenaar' }
			field.solr_local_parameters = {
					qf: '$eigenaar_qf',
					pf: '$eigenaar_pf'
			}
